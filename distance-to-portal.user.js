...
// @updateURL      https://raw.githubusercontent.com/sarinth/s2/main/distance-to-portal.meta.js
// @downloadURL    https://raw.githubusercontent.com/sarinth/s2/main/distance-to-portal.user.js
  ...
  if (window.plugin.distanceToPortal.currentLoc) {
   ...
   var dist = window.plugin.distanceToPortal.currentLoc.distanceTo(ll);
    ...
    $('#portal-distance')
      ...
      .text(ll.lat + ',' + ll.lng)
      .append('&#10;' + cll.lat.toFixed(6) + ',' + cll.lng.toFixed(6))
      .append('&#10;Distance: ' + dist + ' ')
      .append($('<span>')
